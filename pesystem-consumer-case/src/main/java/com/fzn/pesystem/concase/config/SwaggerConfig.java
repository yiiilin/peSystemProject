package com.fzn.pesystem.concase.config;
...
public class SwaggerConfig {
    ...
    public Docket docket(Environment environment){
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .enable(flag)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.fzn.pesystem.concase.controller"))
                .build()
    ...
    private ApiInfo apiInfo(){
        Contact contact = new Contact("xkb", "#", "1422124904@qq.com");
        return new ApiInfo("案件管理服务API",
                "案件管理接口文档说明",
                "v1.0",
